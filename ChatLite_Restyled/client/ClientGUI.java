...
public class ClientGUI extends JFrame {
    ...
    private void showLoginDialog() {
        ...
        // ── form panel: 2-column GridBagLayout (label | field) ──
        ...
        // style password field to match other fields exactly
        ...
        String[] labelTexts = {"Server IP:", "Port:", "Username:", "Password:"};
        ...
        loginStatusLabel.setBorder(new EmptyBorder(6, 20, 0, 0));

        // ── connect button ──
        JPanel btns = new JPanel(new FlowLayout(FlowLayout.RIGHT, 20, 8));
        btns.setBackground(BG_MID);
        loginBtnConnect = accentButton("Connect");
        loginBtnConnect.setPreferredSize(new Dimension(110, 34));
